# -*- encoding: utf-8 -*-
# stub: aws-sdk-route53 1.17.0 ruby lib

Gem::Specification.new do |s|
  s.name = "aws-sdk-route53".freeze
  s.version = "1.17.0"
  ...
  s.date = "2018-12-12"
  s.description = "Official AWS Ruby gem for Amazon Route 53 (Route 53). This gem is part of the AWS SDK for Ruby.".freeze
  s.email = ["trevrowe@amazon.com".freeze]
  s.homepage = "http://github.com/aws/aws-sdk-ruby".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.rubygems_version = "2.7.3".freeze
  s.summary = "AWS SDK for Ruby - Route 53".freeze
