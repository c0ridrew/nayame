# -*- encoding: utf-8 -*-
# stub: aws-sdk-dax 1.8.0 ruby lib

Gem::Specification.new do |s|
  s.name = "aws-sdk-dax".freeze
  s.version = "1.8.0"
  ...
  s.date = "2018-11-20"
  s.description = "Official AWS Ruby gem for Amazon DynamoDB Accelerator (DAX) (Amazon DAX). This gem is part of the AWS SDK for Ruby.".freeze
  s.email = ["trevrowe@amazon.com".freeze]
  s.homepage = "http://github.com/aws/aws-sdk-ruby".freeze
  s.licenses = ["Apache-2.0".freeze]
  s.rubygems_version = "2.7.3".freeze
  s.summary = "AWS SDK for Ruby - Amazon DAX".freeze
